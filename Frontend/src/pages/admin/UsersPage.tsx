  ...
  const fetchSchools = async () => {
    try {
      ...
      const res = await axios.get(
        `${import.meta.env.VITE_API_URL}/schools?limit=100`,
        {
      ...
      accessor: (u: User) => (
        <div className="flex items-center gap-4 py-1">
          ...
          <div className="flex flex-col gap-1">
            <span className="text-[15px] font-black text-gray-900 leading-tight group-hover:text-brand-blue transition-colors">
              {u.name}
            </span>
    ...
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-6 duration-1000">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 px-2 md:px-0">
        <div className="space-y-2 text-center md:text-left">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-gray-900 tracking-tight leading-tight uppercase">
            User Directory
          </h1>
          ...
          <p className="text-gray-400 font-black uppercase tracking-[0.2em] text-[8px] sm:text-[10px] flex items-center justify-center md:justify-start gap-2">
            Security & Access <ChevronRight className="w-3 h-3" />{" "}
            <span className="text-brand-blue">Master Identity Management</span>
          </p>
        </div>
        ...
        <div className="flex gap-4 w-full md:w-auto">
          <button
            ...
            className="flex-1 md:flex-none flex items-center justify-center gap-2 sm:gap-3 px-4 sm:px-6 md:px-10 py-3 sm:py-4 bg-brand-blue text-white rounded-2xl text-[12px] sm:text-[11px] font-black uppercase tracking-widest shadow-xl shadow-brand-blue/30 hover:bg-blue-800 transition-all active:scale-95"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {stats.map((stat, i) => (
          ...
          <div className="flex items-center gap-3 sm:gap-5 bg-white p-4 sm:p-6 md:p-8 rounded-[2rem] md:rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-200/5 transition-all hover:shadow-2xl hover:-translate-y-1 group">
            <div
              className={clsx(
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between bg-white p-3 rounded-2xl border border-gray-100 gap-4">
        <div className="flex gap-2 overflow-x-auto no-scrollbar p-1 w-full">
          {[
        ...
        footer={
          <>
            ...
            <button
              ...
              className="px-12 py-3 bg-brand-blue text-white rounded-2xl font-black text-sm shadow-xl shadow-brand-blue/20 hover:bg-blue-800 transition-all"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-gray-50 border border-transparent rounded-2xl text-sm font-bold focus:outline-none focus:ring-4 focus:ring-brand-blue/5 focus:bg-white focus:border-brand-blue/20 transition-all"
                {...formik.getFieldProps("name")}
              />
              {formik.touched.name && formik.errors.name && (
                <p className="text-red-500 text-[10px] font-black mt-1 ml-1">
                  {formik.errors.name}
                </p>
              )}
            </div>
            ...
            <div className="space-y-2">
              ...
              {/* <CustomSelect
                options={[
                  ...
                  },
                  {
                    ...
                    label: "Platform Architect (Super)",
                  },
                ]}
              ...
              /> */}
                <CustomSelect
                    options={[
                    { value: UserRole.TEACHER, label: "Teacher" },
                    { value: UserRole.SCHOOL_ADMIN, label: "School Administrator" },
                    { value: UserRole.SUPER_ADMIN, label: "Platform Architect (Super)" },
                    ]}
                    value={formik.values.role}
                    onChange={(val) => {
            ...
            <div className="space-y-2">
              ...
              <CustomSelect
                options={[
                { value: "", label: "Global / Independent" },
                ...schools.map((s) => ({
                    value: s.id,
                    label: s.name,
                })),
                ...
                formik.setFieldTouched("schoolId", true);
                }}
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 sm:pl-16 pr-4 sm:pr-6 py-3 sm:py-4 bg-gray-50 border border-transparent rounded-2xl text-sm font-bold focus:outline-none focus:ring-4 focus:ring-brand-blue/5 focus:bg-white focus:border-brand-blue/20 transition-all"
          ...
          <div className="flex items-center justify-between p-6 bg-gray-50 rounded-[2rem]">
            <div>
              ...
              <p className="text-xs font-bold text-gray-400 mt-0.5">
                Allow login and platform interaction
              </p>
            </div>
            <StatusToggle
